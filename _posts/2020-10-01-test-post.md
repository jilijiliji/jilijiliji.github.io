...
* Simulation Environment(Grid) Layer : Simulation Environment(Grid) Layer는 심층강화학습을 적용한 환경을 나타보여준다. 이태원역을 중심으로  1000$$$m^2$$$의 범위를 시뮬레이션 환경으로 한정하였고 1000$$$m^2$$$의 환경은 10$$$m^2$$$의 그리드 10,000개로 이루어져 있다.
